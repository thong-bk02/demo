...
class SalaryExportOne extends \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements FromCollection, ShouldAutoSize, WithHeadings, WithStyles, WithMapping, WithColumnFormatting, WithEvents
{
    /**
    ...
    public function collection()
    {
        $salary = DB::table('salary')
            ...
            ->where("salary.salary_code", session()->get('salary_code'))
            ->select(
                'users.name',
