    ...
    <div class="container">
        ...
        <form action="{{ route('admin.salary.store', $salarys[0]->user_id) }}" method="post">
            ...
            <div class="row mx-lg-5 mx-2">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="working_days" value="" readonly>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" name="total_reward" id="total_reward" value=""
                                readonly>
                        </div>
                        <div class="form-group col-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="income_tax" id="incom_tax" value="" readonly>
                    </div>
                    <div class="form-group">
            ...
            <div class="mx-lg-5 m-2">
                <input type="submit" class="btn btn-primary mx-3" value="Lưu" id="save">
